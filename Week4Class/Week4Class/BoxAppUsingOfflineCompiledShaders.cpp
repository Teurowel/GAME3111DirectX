...
void BoxApp::Update(const GameTimer& gt)
{
	...
	//world = XMMatrixRotationZ((-XM_PI + mTheta2) / 6.f);
...
void BoxApp::BuildShadersAndInputLayout()
{
	...
	//We use alread compiled shader binray file. way faster, don't have to show shader file
	mvsByteCode = d3dUtil::LoadBinary(L"Shaders\\vs.cso");
	mpsByteCode = d3dUtil::LoadBinary(L"Shaders\\ps.cso");
